...
const createPlan = async (req, res) => {
    try {
        const {
            ...
            price, wallet_credits, wallet_tier, ai_credit_cost_per_photo, includes_ai_media
        } = req.body
        ...
        const plan = await prisma.subscriptionPlan.create({
            data: {
                ...
                includes_ai_media: plan_type === "SUBSCRIPTION" ? Boolean(includes_ai_media) : false,
                display_order,
    ...
    try {
        ...
        const plan = await prisma.subscriptionPlan.update({
            ...
            data: {
                ...
                includes_ai_media: effectiveType === "SUBSCRIPTION" ? Boolean(includes_ai_media ?? existing.includes_ai_media) : false,
