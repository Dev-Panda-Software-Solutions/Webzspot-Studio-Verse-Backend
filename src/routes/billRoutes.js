...
const { createBillFromQuotation, getAllBills, getBillById, updateBill, downloadBillPdf } = require("../controllers/billController")
...
router.put("/:id", verifyToken, requireRole("ADMIN"), updateBill)
