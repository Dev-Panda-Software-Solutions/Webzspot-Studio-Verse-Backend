...
const { createQuotation, getAllQuotations, getQuotationById, updateQuotation, deleteQuotation, downloadQuotationPdf } = require("../controllers/quotationController")

router.post("/", verifyToken, requireRole("ADMIN"), createQuotation)
router.get("/", verifyToken, requireRole("ADMIN"), getAllQuotations)
router.get("/:id/pdf", verifyToken, requireRole("ADMIN"), downloadQuotationPdf)
