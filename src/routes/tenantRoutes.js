...
const { getAllTenants, getTenantById, getTenantSummary, createTenant, updateTenant, deleteTenant, hardDeleteTenant, restoreTenant, deleteTenantStorage } = require("../controllers/tenantController")
