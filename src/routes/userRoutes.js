...
const { getAllUsers, getUserById, checkDuplicateClient, createUser, createUserInEvent, updateUser, deleteUser, hardDeleteUser, restoreUser } = require("../controllers/userController")
...
router.get("/check-duplicate", verifyToken, requireRole("SUPER_ADMIN", "ADMIN"), checkDuplicateClient)
